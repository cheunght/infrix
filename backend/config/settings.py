...
INFRIX_GIT_REVISION = os.getenv("INFRIX_GIT_REVISION", "").strip()
...
MEDIA_ROOT = Path(
    os.getenv("INFRIX_MEDIA_ROOT", str(BASE_DIR / "media"))
).expanduser()
MEDIA_URL = "/media/"
ATTACHMENT_MAX_SIZE = _env_int(
    "INFRIX_ATTACHMENT_MAX_SIZE",
    str(20 * 1024 * 1024),
    minimum=1,
)
INFRIX_BACKUP_DIR = Path(
    os.getenv(
        "INFRIX_BACKUP_DIR",
        "/var/lib/infrix/backups" if IS_PRODUCTION else str(BASE_DIR / "backups"),
    )
).expanduser()
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "assets.auth_security.PersonalAccessTokenAuthentication",
...
SPECTACULAR_SETTINGS = {
    ...
    "ENUM_NAME_OVERRIDES": {
        ...
        "DefaultLocaleEnum": "assets.models.SYSTEM_LOCALE_CHOICES",
    },
}
