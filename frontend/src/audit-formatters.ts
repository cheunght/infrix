...
const RESOURCE_LABELS: Record<string, string> = {
  ...
  user_security: "auditLog.resources.user_security",
  api_token: "auditLog.resources.api_token",
};
...
const ACTION_LABELS: Record<string, string> = {
  ...
  upload: "auditLog.actions.upload",
  restore: "auditLog.actions.restore",
  smtp_test: "auditLog.actions.smtp_test",
  assign: "auditLog.actions.assign",
  return: "auditLog.actions.return",
  transfer: "auditLog.actions.transfer",
  bulk_update: "auditLog.actions.bulk_update",
  ...
  login_2fa_required: "auditLog.actions.login_2fa_required",
  login_2fa_failure: "auditLog.actions.login_2fa_failure",
  two_factor_setup_started: "auditLog.actions.two_factor_setup_started",
  two_factor_enabled: "auditLog.actions.two_factor_enabled",
  two_factor_disabled: "auditLog.actions.two_factor_disabled",
  api_token_created: "auditLog.actions.api_token_created",
  api_token_revoked: "auditLog.actions.api_token_revoked",
};
