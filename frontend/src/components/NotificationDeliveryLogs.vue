...
defineExpose({ busy, statusFilter, load, changeStatus });
</script>

<template>
  <div class="settings-maintenance notification-delivery">
    <div class="settings-maintenance__intro">
      <p>{{ t("settings.mailDeliveryDescription") }}</p>
    </div>
    <el-alert v-if="error" :title="error" type="error" :closable="false" />
    <el-table class="notification-delivery__table" v-loading="busy" :data="rows" :empty-text="t('common.noData')">
