        ...
        <PageToolbar>
          ...
          <template #filters>
            <div class="page-toolbar__filter-group">
              <el-select v-model="repairStatus" class="toolbar-filter--sm" :placeholder="t('common.all') + t('common.status')" clearable @change="onRepairStatusChange">
      ...
      <PageContent surface>
        ...
        >
          ...
          <el-table class="repair-table" v-loading="repairListLoading" :data="repairRows" table-layout="fixed">
            ...
            <el-table-column v-if="can('faults.view')" :label="t('common.operation')" fixed="right" width="84">
              <template #default="{ row }">
